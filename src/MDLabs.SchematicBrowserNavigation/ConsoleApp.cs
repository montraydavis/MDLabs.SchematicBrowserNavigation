...
namespace MDLabs.SchematicBrowserNavigation
{
    ...
    public abstract class ConsoleApp : IInputHandler
    {
        ...
        public virtual async Task RunAsync(string consolePrompt, string? inputFilePath = null)
        {
        ...
        public virtual async Task RunAsync(CancellationToken cancelToken = default)
        {
        ...
        /// </summary>
        protected async Task<bool> EvalInputAsync(string input, CancellationToken cancelToken)
        {
            try
            {
